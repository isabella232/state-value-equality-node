 ...
 */
public class StateValueEqualityNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public StateValueEqualityNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
